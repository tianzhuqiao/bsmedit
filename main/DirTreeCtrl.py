...
##        self.addIcon('images/page.png', wx.BITMAP_TYPE_PNG, 'default')
    ...
    def SetRootDir(self, directory):
        ...
        self.SetItemImage(root, self.iconentries['directoryopen'],wx.TreeItemIcon_Expanded)
        #self.Expand(root)
    ...
    def _loadDir(self, item, directory):
        ...
        if self.GetChildrenCount(item) == 0:
            ...
            for f in folders_all:
                ...
                self.SetItemImage(child, self.iconentries['directory'],wx.TreeItemIcon_Normal)
                self.SetItemImage(child, self.iconentries['directoryopen'],wx.TreeItemIcon_Expanded)
